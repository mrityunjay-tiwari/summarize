    ...
    return (
        <main>
            ...
            <div> 
                ...
                : <div className="flex-1 flex justify-center items-center"><EmptySummaryState text="No Summary" description="No summary exists for the id you have entered." linkText="Create summary" /> </div> }
            </div>
        </main>

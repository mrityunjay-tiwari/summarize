        ...
        {items.map((item) => (
          <SortableItem key={item.id} value={item.id}>
            <div
              ...
              onClick={() => {}}
            >
              <SortableItemHandle className="text-muted-foreground hover:text-foreground absolute end-1.5 top-2.5 z-10 opacity-90 transition-opacity group-hover:opacity-100">

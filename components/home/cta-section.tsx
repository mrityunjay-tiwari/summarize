        ...
        <MotionSection variants={ContainerVariants}>
            <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
                <div className="flex flex-col items-center justify-center space-y-4 text-center">
                    <MotionDiv>
                        <MotionH2 initial={{opacity:0, y:20}} whileInView={{opacity:1, y:0}} transition={{duration: 0.5, ease:'easeOut'}} className="text-3xl font-medium tracking-tighter sm:text-4xl md:text-5xl pb-4">Ready to save hours of reading time?</MotionH2>

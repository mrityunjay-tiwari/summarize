      ...
      <div className="relative z-10">
        ...
        <div className="mt-4">
          <div className="space-y-1">
            ...
            <span className="block bg-linear-to-r from-gray-400 via-gray-300 to-gray-500 bg-clip-text text-left font-semibold text-3xl text-transparent tracking-tight dark:from-gray-200 dark:via-white dark:to-gray-300">
              {product.subtitle}
            </span>
          </div>

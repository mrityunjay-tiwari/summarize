...
export default function HeroSection() {
  return (
    <div className="flex w-full max-w-full justify-between gap-10">
      ...
      items-start py-16 sm:py-20 lg:pb-28
      transition-all animate-in lg:px-5 max-w-3xl"
    >
      <div className="">  
        <div className="flex pb-4">
          ...
          >
            <Badge
              variant={"secondary"} 
              className="relative px-4 py-0.5 text-base font-medium
            ...
            >
              ...
              animate-pulse"
              />
              <p className="text-sm text-rose-600">Powered by AI</p>
            </Badge>
          </MotionDiv>
        </div>
      </div>

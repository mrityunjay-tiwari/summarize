...
import { FlashCardsTab } from "./flash_cards-tab"
  ...
  return (
    <div className="flex w-full h-full flex-col gap-4">
      <Tabs defaultValue="chat" className="flex flex-col h-full">
        ...
        <TabsContent value="chat" className="flex-1 mt-0 border-0 p-0 overflow-hidden">
          <ChatTab />
        </TabsContent>
        <TabsContent value="flash-cards" className="flex-1 mt-0 border-0 p-0 overflow-hidden">
          <FlashCardsTab />
        </TabsContent>
        <TabsContent value="quiz" className="flex-1 mt-0 border-0 p-0 overflow-hidden">
          <QuizTab />
        </TabsContent>
        <TabsContent value="mind-map" className="flex-1 mt-0 border-0 p-0 overflow-hidden">
          <MindMapTab />
        </TabsContent>
      </Tabs>
    </div>
